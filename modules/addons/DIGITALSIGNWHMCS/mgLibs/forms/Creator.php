...
class Creator{
    ...
    /**
     * 
     * @param \MGModule\DIGITALSIGNWHMCS\mgLibs\forms\className $field
    ...
    function addField($field,$dataOrName = null,$data = array()){
        ...
        if(is_object($field))
        {
            ...
            {
                throw new \MGModule\DIGITALSIGNWHMCS\mgLibs\exceptions\System('Unable to use this object as form field');
            }
        ...
        elseif(is_string($field) && is_array($data))
        {
            ...
            {
                throw new \MGModule\DIGITALSIGNWHMCS\mgLibs\exceptions\System('Unable to crate form field type:'.$className);
            }
        ...
        {
            throw new \MGModule\DIGITALSIGNWHMCS\mgLibs\exceptions\System('Unable create form field object');
        }
    }
     ...
     * 
     * @param type $prefix
     * @return \MGModule\DIGITALSIGNWHMCS\mgLibs\forms\Creator
     */
