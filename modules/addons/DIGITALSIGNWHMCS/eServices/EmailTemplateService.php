...
class EmailTemplateService {
    ...
    public static function createConfigurationTemplate() {
        ...
        $newTemplate          = new \MGModule\DIGITALSIGNWHMCS\eModels\whmcs\EmailTemplate();
    ...
    public static function updateConfigurationTemplate() {        
        $template          =  \MGModule\DIGITALSIGNWHMCS\eModels\whmcs\EmailTemplate::whereName(self::CONFIGURATION_TEMPLATE_ID)->first();     
    ...
    public static function getTemplate($name) {
        return \MGModule\DIGITALSIGNWHMCS\eModels\whmcs\EmailTemplate::whereName($name)->first();
    }
    
    public static function getTemplateName($id) {
        $template  = \MGModule\DIGITALSIGNWHMCS\eModels\whmcs\EmailTemplate::whereId($id)->first();
    ...
    {
        return \MGModule\DIGITALSIGNWHMCS\eModels\whmcs\EmailTemplate::whereType('product')->get();
    }    
