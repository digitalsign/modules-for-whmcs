...
class ImportSSLOrder extends main\mgLibs\process\AbstractController
{
    ...
    public function indexHTML($input = [], $vars = [])
    {
        ...
        $clients          = array();
        $clientRepisitory = (new\MGModule\DIGITALSIGNWHMCS\models\whmcs\clients\Clients());
    ...
    public function importSSLJSON($input = [], $vars = [])
    {
        try
        {
            ...
            $api = new \MGModule\DIGITALSIGNWHMCS\mgLibs\SSLCenterApi();

            //get order details from API
            $orderStatus = \MGModule\DIGITALSIGNWHMCS\eProviders\ApiProvider::getInstance()->getApi()->getOrderStatus($sslOrderID);
            ...
            $newSSLOrder->setModule('DIGITALSIGNWHMCS');
