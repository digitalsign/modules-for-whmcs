...
class UserCommissions extends main\mgLibs\process\AbstractController
{
    ...
    public function indexHTML($input = [], $vars = [])
    {
        ...
        $clietnsRepo = new \MGModule\DIGITALSIGNWHMCS\models\whmcs\clients\Clients();
    ...
    public function getCommissionRulesJSON($input = [], $vars = [])
    {
        ...
        {
            $data['data']       = array();
            $userCommissionRepo = new \MGModule\DIGITALSIGNWHMCS\models\userCommission\Repository();
    ...
    {
        $clientDetails = new \MGModule\DIGITALSIGNWHMCS\models\whmcs\clients\Client($id);
    ...
    {
        $productDetails = new \MGModule\DIGITALSIGNWHMCS\models\whmcs\product\Product($id);
