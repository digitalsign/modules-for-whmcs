...
/* * ********************************************************************
 * DIGITALSIGNWHMCS product developed. (2015-12-08)
 * *
 *
...
namespace MGModule\DIGITALSIGNWHMCS\models\whmcs\pricing;
...
class BillingCycle
{
    ...
    static function convertPeriodToString($period)
    {
        ...
        throw new \MGModule\DIGITALSIGNWHMCS\mgLibs\exceptions\System('Invalid period: ' . $period);
    }
    ...
    static function convertStringToPeriod($string)
    {
        ...
        throw new \MGModule\DIGITALSIGNWHMCS\mgLibs\exceptions\System('Invalid period: ' . $string);
    }
