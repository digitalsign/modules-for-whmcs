...
namespace MGModule\DIGITALSIGNWHMCS\eRepository\whmcs\config;
...
class Countries {
    ...
    private function loadCountriesWhmcs6() {
        $ccPath = \MGModule\DIGITALSIGNWHMCS\eProviders\PathProvider::getWhmcsCounriesPatch(6);
    ...
    private function loadCountriesWhmcs7() {
        $ccPath = \MGModule\DIGITALSIGNWHMCS\eProviders\PathProvider::getWhmcsCounriesPatch(7);
